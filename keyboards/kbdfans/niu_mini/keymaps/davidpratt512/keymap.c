...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* Numpad Layer */
    [1] = LAYOUT_planck_mit(
            KC_TRNS, KC_NUM, UG_HUEU, UG_SATU, UG_VALU, KC_LBRC, KC_RBRC, KC_P7, KC_P8, KC_P9, KC_EQL, KC_TRNS,
    ...
    [2] = LAYOUT_planck_mit(
            ...
            KC_TRNS, KC_F5, KC_F6, KC_F7, KC_F8, UG_NEXT, MO(3), KC_F9, KC_F10, KC_F11, KC_F12, KC_TRNS, 
            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_END, KC_TRNS, KC_TRNS
    ),
    /* RESET & RGB Lighting */
    [3] = LAYOUT_planck_mit(
